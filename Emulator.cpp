...
int Emulator::ExecuteOpcode(BYTE opcode) {
	...
	switch (opcode) {
		...
		case 0x3E: { LD(cpu.A, memory.mem[cpu.HL]); break; }
		...
		case 0x0C: { INC(cpu.A); break; }
		case 0x14: { INC(cpu.A); break; }
		case 0x1C: { INC(cpu.A); break; }
		case 0x24: { INC(cpu.A); break; }
		case 0x2C: { INC(cpu.A); break; }
